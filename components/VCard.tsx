        ...
        <Card title="Contact" icon={<MailIcon className="w-5 h-5" />} delay={0.2}>
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-sm">
              ...
              <a href="mailto:adicodes@outlook.com" className="text-charcoal/70 hover:text-orange transition-colors">
                adicodes@outlook.com
              </a>
            </div>
            <div className="flex items-center gap-2 text-sm">
              <GithubIcon className="w-4 h-4 text-orange" />
              <span className="text-charcoal/70">@Aditya1156</span>
            </div>
